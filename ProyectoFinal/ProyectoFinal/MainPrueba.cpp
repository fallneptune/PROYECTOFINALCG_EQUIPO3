...
glm::vec3 spotlight = glm::vec3(0);
glm::vec2 lightDir = glm::vec3(0);
...
int main()
{
	...
	Model Piso((char*)"Models/Sea/Sea2.obj");
	Model SV((char*)"Models/Sea/salvavidas.obj");
	Model caja((char*)"Models/sea/caja.obj");
	Model wilson((char*)"Models/Sea/wilson.obj");
	Model daniel((char*)"Models/pfinal/proyectofinal3.obj");
	...
	/*	 Also draw the lamp object, again binding the appropriate shader*/
		...
		model = glm::scale(model, glm::vec3(35.0f)); // Make it a smaller cube
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
